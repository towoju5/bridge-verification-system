    ...
    protected function bitnob()
    {
        try {
            ...
            $validatedData = [
                ...
                'country' => $country ?? $data['registered_address']['country'] ?? null,
                'city' => $addr['city'] ?? $data['registered_address']['city'] ?? '',
                'state' => $addr['state'] ?? $data['registered_address']['country'] ?? '',
                'zipCode' => $addr['postal_code'] ?? '',
                'line1' => $addr['street_line_1'] ?? $data['registered_address']['street_line_1'] ?? '',
                'houseNumber' => '',
                'idType' => $idType,
