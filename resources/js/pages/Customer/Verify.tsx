    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="first_name" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">First Name</label>
                    <input
                        type="text"
                        id="first_name"
                        name="first_name"
                ...
                <div>
                    <label htmlFor="middle_name" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Middle Name</label>
                    <input
                        type="text"
                        id="middle_name"
                        name="middle_name"
                ...
                <div>
                    <label htmlFor="last_name" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Last Name</label>
                    <input
                        type="text"
                        id="last_name"
                        name="last_name"
                ...
                <div>
                    <label htmlFor="last_name_native" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Last Name (Native)</label>
                    <input
                        type="text"
                        id="last_name_native"
                ...
                <div>
                    <label htmlFor="taxId" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Tax ID</label>
                    <input
                        type="text"
                        id="taxId"
                        name="taxId"
                ...
                <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Email Address</label>
                    <input
                        type="email"
                        id="email"
                        name="email"
                ...
                <div>
                    <label htmlFor="birth_date" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Date of Birth</label>
                    <input
                        type="date"
                        id="birth_date"
                        name="birth_date"
                ...
                <div>
                    <label htmlFor="nationality" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Nationality</label>
                    <select
                        id="nationality"
                        name="nationality"
                ...
                <div>
                    <label htmlFor="second_last_name" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Second Last Name</label>
                    <input
                        type="text"
                        id="second_last_name"
                ...
                <div>
                    <label htmlFor="gender" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Select Gender</label>
                    <select
                        id="gender"
                        name="gender"
                        value={data.gender || ''}
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                    <label htmlFor="street_line_1" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Street Line 1</label>
                    <input
                        type="text"
                        id="street_line_1"
                        ref={streetInputRef}
                ...
                <div className="md:col-span-2">
                    <label htmlFor="street_line_2" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Street Line 2</label>
                    <input
                        type="text"
                        id="street_line_2"
                ...
                <div>
                    <label htmlFor="city" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">City</label>
                    <input
                        type="text"
                        id="city"
                        value={address.city || ''}
                ...
                <div>
                    <label htmlFor="state" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">State/Province(ISO-3166) </label>
                    <input
                        type="text" id="state"
                ...
                <div>
                    <label htmlFor="postal_code" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Postal Code</label>
                    <input
                        type="text"
                        id="postal_code"
                ...
                <div>
                    <label htmlFor="country" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Country</label>
                    <select
                        id="country"
                ...
                <div className="md:col-span-2">
                    <label htmlFor="proof_of_address" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Proof of Address</label>
                    <input
                        type="file"
                        accept=".pdf,.jpeg,.jpg,.png,.heic,.tif"
            ...
            {docs.map((doc, index) => (
                <div key={index} className="border border-gray-200 rounded-md p-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Issuing Country</label>
                            <select
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Document Type</label>
                            <select
                                value={doc?.type || ''}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Document Number</label>
                            <input
                                type="text"
                                value={doc?.number || ''}
                        ...
                        {(doc?.type === 'other' || !doc?.type) && (
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Description</label>
                                <input
                                    type="text"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Date Issued</label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Expiration Date</label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Front of Document</label>
                            <input
                                type="file"
                                accept=".pdf,.jpeg,.jpg,.png,.heic,.tif"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Back of Document</label>
                            <input
                                type="file"
                                accept=".pdf,.jpeg,.jpg,.png,.heic,.tif"
...
const EmploymentFinancesStep: React.FC<StepProps> = ({ data, onDataChange, occupations = [], accountPurposes = [], sourceOfFunds = [] }) => (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <label htmlFor="employment_status" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Employment Status</label>
                <select
            ...
            <div>
                <label htmlFor="most_recent_occupation_code" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Most Recent Occupation</label>
                <select
            ...
            <div>
                <label htmlFor="expected_monthly_payments_usd" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">
            ...
            <div>
                <label htmlFor="source_of_funds" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Source of Funds</label>
                <select
                    id="source_of_funds"
            ...
            <div>
                <label htmlFor="account_purpose" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Account Purpose</label>
                <select
                    id="account_purpose"
            ...
            {data.account_purpose === 'other' || data.account_purpose === 'Other' && (
                <div>
                    <label htmlFor="account_purpose_other" className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Account Purpose (Other)</label>
                    <input
                        type="text"
            ...
            {docs.map((doc, index) => (
                <div key={index} className="border border-gray-200 rounded-md p-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-white dark:text-white">Upload File</label>
                            <input
                                type="file"
                                accept=".pdf,.jpeg,.jpg,.png,.heic,.tif"
                                onChange={(e) => {
