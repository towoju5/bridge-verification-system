...
import { RegulatoryTab } from '@/components/BusinessCustomerForm/tabs/RegulatoryTab';
import Regulatory from './components/Regulatory';
import { BusinessCustomerFormProps, Occupation, InitialData, Country } from './shared/data';
        ...
        <AppLayout title="Select Account Type">
            ...
            <div className="max-w-6xl mx-auto p-6">
                ...
                <form className="space-y-6">
                    ...
                    {activeTab === 'persons' && (
                        <AssociatedPersons formData={formData} setFormData={setFormData} setActiveTab={setActiveTab} />
                    )}
                    ...
                    {activeTab === 'financial' && (
                        <FinancialInformation
                            ...
                            estimatedRevenueOptions={estimatedRevenueOptions}
                        />
                    )}

                    {activeTab === 'regulatory' && (
                        <Regulatory formData={formData} setFormData={setFormData} setActiveTab={setActiveTab} />
                    )}
